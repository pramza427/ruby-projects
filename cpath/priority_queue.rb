...
#
## ***********************************
# I am using code that I found online because there is
# no priority queue native to Ruby, and since the write up
# tells C++ coders to use priority queue STL in C++ I
# figured this was allowed.
# I altered the code slightly to better fit the purposes of
# this project
#
# The author and code can be found here:
...
class PQueue
  ...
  # using the #<=> method.
  #
  def initialize # :yields: a, b
  @que = []
  @cmp = lambda { |a, b| a.cost == b.cost ? b.time <=> a.time : b.cost <=> a.cost }
  end
